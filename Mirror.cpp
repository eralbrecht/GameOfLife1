...
char editCells(char world[], int c, int r)
{
	...
	for (int i = 0; i < (c*r); ++i)
	{
		...
		if (lineCount == 0)
		{
			...
			if (columnCount == 0)
			{
				if (world[lineCount][columnCount] == 'X')//count above
				{
					nCount += 1;
				}
				if (world[lineCount][columnCount + 1] == 'X')//count diagonal right up
				{
					nCount += 1;
				}
				...
				if (world[lineCount + 1][columnCount] == 'X')//count diagonal left down
				{
					nCount += 1;
				}
				if (world[lineCount][columnCount] == 'X')//count left
				{
					nCount += 1;
				}
				if (world[lineCount][columnCount] == 'X')//count diagonal left up
				{
					nCount += 1;
				}
			}
			...
			if (columnCount > 0 && columnCount < c - 1)//first line -- not either top corner
			{
				...
				if (world[lineCount][columnCount - 1] == 'X')//count diagonal left up
				{
					nCount += 1;
				}
			...
			if (columnCount == c - 1)
			{
				...
				if (world[lineCount][columnCount] == 'X')//count diagonal right up
				{
					nCount += 1;
				}
				if (world[lineCount][columnCount] == 'X')//count right
				{
					nCount += 1;
				}
				if (world[lineCount + 1][columnCount] == 'X')//count diagonal right down
				{
					nCount += 1;
				}
				if (world[lineCount + 1][columnCount] == 'X')//count below
		...
		if (lineCount > 0 && lineCount < r-1)
		{
			...
			if (columnCount == 0)
			{
				...
				if (world[lineCount - 1][columnCount] == 'X')//count diagonal left up
				{
					nCount += 1;
				}
			}
			...
			if (columnCount == c-1)
			{
				...
				if (world[lineCount - 1][columnCount] == 'X')//count diagonal right up
				{
					nCount += 1;
				}
				if (world[lineCount][columnCount] == 'X')//count right
		...
		if (lineCount == 0)
		{
			...
			if (columnCount == 0)
			{
				...
				if (world[lineCount][columnCount] == 'X')//count below
				{
					nCount += 1;
				}
				if (world[lineCount][columnCount ] == 'X')//count diagonal left down
				{
					nCount += 1;
				}
				if (world[lineCount][columnCount ] == 'X')//count left
			...
			if (columnCount > 0 && columnCount < c - 1)
			{
				...
				if (world[lineCount ][columnCount - 1] == 'X')//count diagonal left down
				{
					nCount += 1;
				}
				if (world[lineCount][columnCount - 1] == 'X')//count left
			...
			if (columnCount == c - 1)
			{
				...
				if (world[lineCount ][columnCount] == 'X')//count diagonal right down
				{
					nCount += 1;
				}
				if (world[lineCount ][columnCount] == 'X')//count below
